<?php
    function site_files(){
        ...
        // wp_enqueue_style('site-main-styles', get_stylesheet_uri());
        // wp_enqueue_script('masonry-layout', '//unpkg.com/masonry-layout@4/dist/masonry.pkgd.min.js', NULL, '1.0', true);    
